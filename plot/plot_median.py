...
def plot(ename, exception, tasks):
    ...
    figname = ename + '-' + exception + 'median.pdf'
    plt.savefig(figname)
    figname = ename + '-' + exception + 'median.png'
    plt.savefig(figname)
...
def get_style(name):
    style = {
        ...
        'MUC_LwF': {'linestyle': '-', 'color': 'peru', 'legend': 'MUC_LwF', 'width': 8},
        'SI': {'linestyle': '-', 'color': 'blue', 'legend': 'SI', 'width': 8},
        'LwF': {'linestyle': (0, ()), 'color': 'cyan', 'legend': 'LwF', 'width': 8},
        'GD': {'linestyle': (0, ()), 'color': 'darkorange', 'legend': 'GD', 'width': 8},
        'GD+WILD': {'linestyle': (0, ()), 'color': 'yellowgreen', 'legend': 'GD+WILD', 'width': 8},
        'GEM': {'linestyle': (0, ()), 'color': 'gold', 'legend': 'GEM', 'width': 8},
        'A-GEM': {'linestyle': (0, ()), 'color': 'steelblue', 'legend': 'A-GEM', 'width': 8},
        'OWM': {'linestyle': (0, ()), 'color': 'purple', 'legend': 'OWM', 'width': 8},
