...
def plot():
    names = ['cifar100-10.json',  'tiny25.json']  # 'cifar100-20.json',
    title = ['(a) 10-split CIFAR-100',  # '(b) 20-split CIFAR-100',
             '(b) 25-split TinyImageNet',
             '(c) 10-split CIFAR-100',  # '(b) 20-split CIFAR-100',
             '(d) 25-split TinyImageNet',
             ]
    tx = [0.13, 0.59, 0.13, 0.59]
    ty = [0.56, 0.56, 0.11, 0.11]
